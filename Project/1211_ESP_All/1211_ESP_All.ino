...
///////////// pin numbers - /////////////////
int pulseSCL = 32;  // check whether it works - previously in 22
int pulseSDA = 33;  // check whether it works - previously in 21
int musclePin = 35;
//int LCDpin = ??????;
